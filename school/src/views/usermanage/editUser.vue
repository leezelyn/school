...
const onSubmit = async (values) => {
    ...
    Object.assign(form,{role:form.role})

    const res = await upload(`/adminapi/users/update/${route.params.id}`, form)
...
onMounted(async()=>{
    const res = await axios.get(`/adminapi/users/list/${route.params.id}`)
